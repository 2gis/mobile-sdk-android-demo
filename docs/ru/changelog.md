...
- В навигаторе добавлено автоматическое управление масштабом при помощи `NavigationZoomFollowController` и управление наклоном камеры при помощи `ZoomToTiltRelation`.
